...
export default function About() {
  return (
    <div className="max-w-2xl mx-auto py-16 px-4 text-[#222]">
      ...
      <h2 className="text-xl font-semibold mt-10 mb-2">Technical Skills</h2>
