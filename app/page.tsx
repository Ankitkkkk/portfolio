    ...
    <div className="flex flex-col items-center w-full px-4">
      ...
      <section className="flex flex-col items-center w-full">
        <div className="bg-white rounded-xl shadow-lg p-10 max-w-2xl w-full mt-12 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-2">
            ...
            <a href="/ankit-resume.pdf" className="px-5 py-2 rounded bg-[#222] text-white hover:bg-[#444] transition">Download Public Resume</a>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="w-full flex justify-center scroll-mt-24 mt-16 mb-12">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-2xl w-full">
          ...
          <div className="mb-6">
            <div className="mb-2"><span className="font-medium text-[#222]">Phone:</span> <a href="tel:+91xxxxyyyyzz" className="text-[#6c757d] hover:underline">+91 xxxxyyyyzz</a></div>
          ...
          <a href="/ankit-resume.pdf" className="px-5 py-3 rounded bg-[#222] text-white hover:bg-[#444] transition">Download Public Resume</a>
        </div>
      </section>
    </div>
  );
